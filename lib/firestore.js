...
export async function getBranches() {
    const snap = await getDocs(query(branchesRef, orderBy("name")));
...
export function onBranchesSnapshot(callback) {
    return onSnapshot(query(branchesRef, orderBy("name")), (snap) => {
